...
if st.button("🔍 ค้นหาร้านอาหาร"):
    ...
    if matched_restaurants:
        ...
        selected_store = st.radio("เลือกร้านที่คุณสนใจ:", matched_restaurants, key="select_store")

        confirm = st.button("✅ เลือกร้านนี้")
        no_match = st.button("❌ ไม่มีร้านไหนที่ตรงใจ")
        ...
        if st.button("❌ ไม่มีร้านไหนที่ตรงใจ", key="no_match_none"):
            st.warning("ขอบคุณสำหรับความคิดเห็น! ระบบจะนำไปปรับปรุงต่อไป 🙏")
