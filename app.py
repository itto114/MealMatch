...
# ตัวเลือกต่าง ๆ
loaction = st.selectbox("บริเวณที่ต้องการจะไป", ["ประตู 1","ประตู 2","ประตู 3","ประตู 4"])
...
if st.button("ค้นหาร้านอาหาร"):
    st.success(f"แนะนำร้านอาหารบริเวณ {location} ประเภท {type_choice} ในช่วง {time} ที่อยู่ในงบ {budget} 👍")
